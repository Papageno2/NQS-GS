...
import numpy as np
# from HS_spin2d import Heisenberg2DTriangle, Heisenberg2DSquare, value2onehot
...
def main(g, L, W, Dp, ms):
    state_size = [L,W,Dp]
    _ham = TFIMSpin2D(g=g, state_size=state_size, pbc=False)
...
if __name__ == '__main__':
    ...
    # sio.savemat('ed_data_TFIM2D_L2W2.mat',{'ge':ge})
    plt.figure()
